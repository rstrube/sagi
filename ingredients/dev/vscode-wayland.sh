...
cp /usr/share/applications/visual-studio-code.desktop ${HOME}/.local/share/applications/.
sed -i 's/\/opt\/visual-studio-code\/code/& --enable-features=UseOzonePlatform --ozone-platform=wayland/' ${HOME}/.local/share/applications/visual-studio-code.desktop
